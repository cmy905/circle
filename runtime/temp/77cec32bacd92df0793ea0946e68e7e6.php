<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:61:"C:\wamp64\www/application/home\view\upload\upload_comics.html";i:1493169162;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<title>新增漫画</title>
...
<nav class="navbar navbar-inverse navbar-fixed-top">
                ...
                <div class="upload-grids">
                    ...
                    <div class="upload-right-bottom-grids">
                     <div class="recommended-info">
                        ...
                        <form class="navbar-form navbar-right" id="add_comics" name="add_comics" method="post" action=<?php echo url('add_comics'); ?>>
                            <h3>漫画名称</h3>
                            <input type="text" class="form-control" id="name" name="name" placeholder="必填">
                            <br /><br />
                            <h3>漫画说明</h3>
                            <textarea type="text" class="form-control" placeholder="" id="detail" name="detail" style="height: 170px;"></textarea>
                             <br /><br />

                            <h3>标签</h3>
                            <input type="text" class="form-control" placeholder="只能写一个" id="tag" name="tag">
                            <br /><br />
    ...
    $(function(){
        ...
        function checkForm(){
            if( '' == $.trim($('#name').val())){
                var name=$("#name").val();
                layer.msg('请输入漫画名', {icon: 5,time:2000}, function(index){
                    layer.close(index);
                });
                return false;
            }

            $("loginsub").removeClass('btn-primary').addClass('btn-danger').text("提交...");
        }
        ...
        function complete(data){
            if(data.code==1){
                ...
                $("loginsub").removeClass('btn-danger').addClass('btn-primary').text("提 交");
                return false;
            }
