<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:44:"./template/home/default\setting\collect.html";i:1487062570;s:42:"./template/home/default\Public\header.html";i:1487293929;s:40:"./template/home/default\Public\left.html";i:1487056634;s:42:"./template/home/default\Public\footer.html";i:1487141259;}*/ ?>
<!DOCTYPE html>
...
<div class="container clearfix">
    ...
    <div class="member_main">
        ...
        <?php if(empty($collect_list) || ($collect_list instanceof \think\Collection && $collect_list->isEmpty())): ?>
        ...
        <?php else: ?>
        	<table class="table_member">
                ...
                <tbody>
                <?php if(is_array($collect_list) || $collect_list instanceof \think\Collection): $i = 0; $__LIST__ = $collect_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$collect): $mod = ($i % 2 );++$i;?>
                <tr>
                    <td align="center"><b class="green"><?php echo $collect['username']; ?></b></td>
                    <td align="center"><a href="<?php echo $collect['url']; ?>"><?php echo $collect['title']; ?></a></td>
                    
                    <td align="center"><?php echo $collect['create_time']; ?></td>
