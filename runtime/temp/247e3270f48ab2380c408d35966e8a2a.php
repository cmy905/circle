<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:40:"./template/home/default\user\forget.html";i:1487245319;s:42:"./template/home/default\Public\header.html";i:1487293929;s:42:"./template/home/default\Public\footer.html";i:1487141259;}*/ ?>
<!DOCTYPE html>
...
<div class="wrap">
    <div class="pop-title clearfix">
        <a class="a_underline" href="<?php echo url('login/'); ?>">登陆</a>
        <div class="pop_name">
    ...
    <form id="forget-form" onsubmit="return false">
        <div class="pop-content accountPage">
            <?php if($email == ''): ?>
                <div class="form_item">
                    <span class="grey">找回密码:</span>
                    <input type="text" placeholder="邮箱用于找回密码"  name="email" class="form_input"  datatype="e" nullmsg="请填写注册时的邮箱" errormsg="邮箱格式不正确，请重新填写"/>

                </div>

                <input type="submit" tabindex="7" value="发   送" class="btn_reg btn" id="btn-forget" style="margin-left: 55px;">
                <?php else: ?>

                <p>我们已将重设密码邮件发到你的邮箱<span>&nbsp;<?php echo $email; ?></span></p>
                <p>请前往你的邮箱查收邮件。邮件一个小时内有效</p>
                <p>请点击邮件中的链接，即可进行密码修改。</p>
                <p><a href="http://mail.qq.com">去邮箱验证</a></p>
                <p class="prompt">如果在邮箱中无法找到93素材网的邮件，请到“垃圾邮件”或与我们联系</p>
