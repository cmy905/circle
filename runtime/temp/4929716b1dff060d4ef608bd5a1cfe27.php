<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:66:"/home/wwwroot/default/application/home/view/upload/usercomics.html";i:1491835474;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<title>漫画管理</title>
						...
						<div class="recommended-grids english-grid">
							...
							<div class="col-md-3 resent-grid recommended-grid movie-video-grid">
								...
								<div class="resent-grid-info recommended-grid-info recommended-grid-movie-info">
									<a id="detail" class="play-icon">管理</a>
									
									<ul>
										<li><p class="author author-info"><a href="#" class="author"><?php echo $auther['username']; ?></a></p></li>
