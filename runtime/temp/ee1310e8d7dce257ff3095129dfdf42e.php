<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:43:"./template/home/default\setting\avatar.html";i:1487058248;s:42:"./template/home/default\Public\header.html";i:1487293929;s:40:"./template/home/default\Public\left.html";i:1487056634;s:42:"./template/home/default\Public\footer.html";i:1487141259;}*/ ?>
<!DOCTYPE html>
...
<div class="container clearfix">
    ...
    <div class="member_main">
       ...
       <div class="setting-right-wrap wrap-boxes settings" id="avatar_main">
            ...
            <div class="webuploader-pick" id="avatar_uplpad_btn">上传图像</div> 
            ...
            <!--头像显示-->
            <div id="show_photo">
           		 <img  width="100" height="80" <?php if($user_info['avatar'] == ''): ?> src="__IMG__/default.gif" <?php else: ?>src="<?php echo $user_info['avatar']; ?>"<?php endif; ?>alt="头像">
            ...
            var uploader_avatar = new plupload.Uploader({//创建实例的构造方法
                ...
                init: {
                    ...
                    FileUploaded: function(up, file, info) { //文件上传成功的时候触发
                          ...
                          if(data.status == 1){
                       	   $("#show_photo img").attr("src",data.image_path);
                              $("#loading_bar").hide();
                              $("#avatar_pic").show();
                          }else{
                       	   alert(data.info);
