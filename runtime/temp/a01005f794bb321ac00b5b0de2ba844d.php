<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:43:"./template/home/default\account\record.html";i:1487064440;s:42:"./template/home/default\Public\header.html";i:1487293929;s:40:"./template/home/default\Public\left.html";i:1487056634;s:42:"./template/home/default\Public\footer.html";i:1487141259;}*/ ?>
<!DOCTYPE html>
...
<div class="container clearfix">
    ...
    <div class="member_main">
        ...
        <?php if(empty($record_list) || ($record_list instanceof \think\Collection && $record_list->isEmpty())): ?>
        ...
        <?php else: ?>
         <table class="table_member">
                ...
                <tbody>
                <?php if(is_array($record_list) || $record_list instanceof \think\Collection): $i = 0; $__LIST__ = $record_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$record): $mod = ($i % 2 );++$i;?>
                <tr>
                    <td align="center"><?php echo $record['orderid']; ?></td>
                    <td align="center"><?php echo $record['username']; ?></td>
                     <td align="center"><b style="color:red"><?php echo $record['money']; ?>元</b></td>
                    <td align="center"><b style="color:red"><?php echo $record['points']; ?>积分</b></td>

                    <td align="center"><?php if($record['serial_umber'] == ''): ?>---<?php endif; ?><?php echo $record['serial_umber']; ?></td>
                    <td align="center"><?php echo date("Y-m-d H:i:s",$record['create_time']); ?></td>
                  
                    <td align="center">
	                    <span style="color:#FF6600">
	                    <?php if($record['status'] == 2): ?>等待付款<?php elseif($record['status'] == 1): ?>充值成功<?php else: ?>充值失败<?php endif; ?>
	                    </span>
                    </td>
                </tr>
                <?php endforeach; endif; else: echo "" ;endif; ?>
