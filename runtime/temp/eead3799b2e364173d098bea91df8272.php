<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:41:"./template/admin/default/index/index.html";i:1489799643;s:43:"./template/admin/default/public/header.html";i:1489799643;s:43:"./template/admin/default/public/footer.html";i:1489799643;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    ...
    <div class="layui-header header header-admin">
        <div class="layui-main">
            <div class="fhuaui-logo">
                <a class="logo" href="/">
                    <img src="__img__/fhua/logo.png" alt="CircleAdmin" />
                </a>
            </div>
           <!-- <ul class="layui-nav">
