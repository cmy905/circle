<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:46:"./template/home/default\setting\downloads.html";i:1487061863;s:42:"./template/home/default\Public\header.html";i:1487293929;s:40:"./template/home/default\Public\left.html";i:1487056634;s:42:"./template/home/default\Public\footer.html";i:1487141259;}*/ ?>
<!DOCTYPE html>
...
<div class="container clearfix">
    ...
    <div class="member_main">
        ...
        <?php if(empty($down) || ($down instanceof \think\Collection && $down->isEmpty())): ?>
        ...
        <table class="table_member">
                <tbody><tr>
                    ...
                    <th align="center">消耗积分</th>
                    <th align="center">操作时间</th>
                   
                </tr>
                </tbody>
                <tbody>
                <?php if(is_array($down) || $down instanceof \think\Collection): $i = 0; $__LIST__ = $down;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$dw): $mod = ($i % 2 );++$i;?>
                    <tr>
                        <td align="center"><b class="green"><?php echo $dw['username']; ?></b></td>
                         <td align="center"><a href="<?php echo $dw['url']; ?>"><?php echo $dw['title']; ?></a></td>
                        <td  align="center" width="100px"><strong class="red"><?php echo $dw['points']; ?>积分 </strong></td>
                        <td align="center"><?php echo $dw['create_time']; ?></td>
