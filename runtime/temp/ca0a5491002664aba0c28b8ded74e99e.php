<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:62:"C:\wamp64\www/application/home\view\collect\comics_detail.html";i:1492961161;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<title>History</title>
			...
			<div class="show-top-grids">
				...
				<!--<div class="col-sm-8 single-left">-->
					...
					<div class="load_more" style="height: 230px;">	
						<ul style="width: 450px;margin-left: 270px;">
					...
					<div style="font-size: 12px; float: left;margin-left: 50px;">
					...
					<br /><br />
						<input type="button" id="detail" class="btn btn-primary" style="margin-left: 50px;" name="detail" value="开始阅读">	
							...
							<script>
								$(document).ready(function () {
									...
									$('#detail').click(function(event) {
										/* Act on the event */
										window.location.href="<?php echo url('comics_look',array('book'=>$book['id'],'chapter'=>1)); ?>";
									});
								});
							</script>
			    ...
			    <div class="chapterlist_box" style="margin-left: 35px;">
								        ...
								        success:function(data,textStatus,jqXHR){
								            if(data.code==1){
								                layer.msg(data.msg, {icon: 6,time:1500,shade: 0.1}, function(index){
								                    ...
								                    window.location.href = "<?php echo url('comics_look',array('book'=>$book['id'])); ?>"+"?chapter="+zid;
								                });
								            }else{
