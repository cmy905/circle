<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:56:"C:\wamp64\www/application/home\view\collect\collect.html";i:1493431765;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<title>History</title>
				...
				<div class="col-sm-10 show-grid-left main-grids">
					<div class="recommended">
						<div class="recommended-grids english-grid">
							...
							<?php if(is_array($list) || $list instanceof \think\Collection): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$collectcomics): $mod = ($i % 2 );++$i;?>
							<div class="col-md-3 resent-grid recommended-grid movie-video-grid">
							    
								<div class="resent-grid-img recommended-grid-img">
									<a><img src="<?php echo $collectcomics['image_path']; ?>" onclick="comic_detail(<?php echo $collectcomics['id']; ?>)" alt="" /></a>
								</div>
								<div class="resent-grid-info recommended-grid-info recommended-grid-movie-info">									
									<ul>
										<li><p class="author author-info"><a href="#" class="author">更新至<?php echo $collectcomics['update_until']; ?>章</a></p></li>
								        <li class="right-list"><p class="views views-info"><?php echo $collectcomics['browse_count']; ?> views</p></li>
									</ul>
								</div>
								        ...
								        success:function(data,textStatus,jqXHR){
								            if(data.code==1){
								                ...
								                function(index){
								                    ...
								                    window.location.href = "<?php echo url('/home/index/single'); ?>"+"?book="+id;
								                });
								            }else{
