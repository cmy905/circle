<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:56:"C:\wamp64\www/application/home\view\concern\concern.html";i:1492938635;}*/ ?>
/<!DOCTYPE HTML>
<html>
<head>
<title>History</title>
			...
			<div class="recommended">
				...
				<div class="col-md-3 resent-grid recommended-grid">
					<div class="resent-grid-img recommended-grid-img">
						<a><img src="<?php echo $concern['image']; ?>" onclick="auther_info(<?php echo $concern['id']; ?>)" alt="" /></a>							
					</div>
					<div class="resent-grid-info recommended-grid-info video-info-grid">
						<h5><a href="javascript:void(0)"  class="title"><?php echo $concern['nickname']; ?></a></h5>
						<ul>
							<li><p><?php echo $concern['signature']; ?></p></li>
			        ...
			        <script>
								...
								function auther_info(id){

									//var username = $("#username").val();

									$.ajax({
								        url:"<?php echo url('auther_info'); ?>",
								        type:'POST', //GET
								        ...
								        success:function(data){
								            if(data.code==1){
								                layer.msg(data.msg, {icon: 6,time:1500,shade: 0.1}, function(index){
								                    ...
								                    window.location.href = "<?php echo url('user_info'); ?>"+"?id="+id;
					...
					<div class="recommended-info">
						...
						<div class="history-grids" >
							...
							<div class="col-md-11 history-right" >
								<h5 onclick="info(<?php echo $concern['id']; ?>)"><?php echo $concern['nickname']; ?></h5>

								<p><?php echo $concern['signature']; ?></p>
							</div>
							<div class="clearfix"> </div>
