<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:41:"./template/home/default\setting\info.html";i:1487294742;s:42:"./template/home/default\Public\header.html";i:1487321446;s:40:"./template/home/default\Public\left.html";i:1487056634;s:42:"./template/home/default\Public\footer.html";i:1487141259;}*/ ?>
<!DOCTYPE html>
    ...
    <div class="member_main" id="member_index">
             <div class="balance clearfix">
                ...
                <div class="balance-info">
                    <div class="balance-title">当月收入<span>（积分）</span></div>
                    <div class="balance-content">
                        <span class="money"><?php if($income != ''): ?><?php echo $income; else: ?>0<?php endif; ?></span>
                        <span class="unit">积分</span>
                    </div>	
                </div>
                 <div class="balance-info">
                    <div class="balance-title">当月支出<span>（积分）</span></div>
                    <div class="balance-content">
                        <span class="money"><?php if($spending != ''): ?><?php echo $spending; else: ?>0<?php endif; ?></span>
                        <span class="unit">积分</span>
                    </div>	
                </div>
                
                 <div class="balance-info" style="border-right: none">
                    <div class="balance-title">可用积分</div>
                    <div class="balance-content">
                        <span class="money"><?php echo $user_info['integral']; ?></span>
                        <span class="unit">积分</span>
                         <a class="exchange_btn balance_right" href="javascript:;" onclick="alert('敬请期待')">兑换礼品</a>
                    </div>	
                </div>
            </div>
       <!--  <a href="http://www.fxzhihui.com/Uploads/index" class="upload_big_btn"><i></i>上传资源</a> -->
       		  <div class="sign_info">
			            今天<strong class="red"><?php if(empty($sign) || ($sign instanceof \think\Collection && $sign->isEmpty())): ?>未签到<?php else: ?>已签到<?php endif; ?></strong>
			                            本周已签到 <strong class="red"><?php echo $user_info['sign_count']; ?></strong> 次，还差 <strong class="red"><?php echo $sum-$user_info['sign_count']; ?></strong> 次即可获取50积分。
             </div>
              <div class="perInfo">
	            <div class="titleInfoBorder">
	                <span>签到记录</span>
	               	<a class="want" href="<?php echo url('/setting/points'); ?>">更多</a>
	            </div>
                <?php if(empty($income_list) || ($income_list instanceof \think\Collection && $income_list->isEmpty())): ?>
                  <div class="infoPerBlock">暂无签到记录</div>
                  <?php else: if(is_array($income_list) || $income_list instanceof \think\Collection): $i = 0; $__LIST__ = $income_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$income): $mod = ($i % 2 );++$i;?>
                      <div class="infoPerBlock">

                          <div class="centerBlock w490">
                              <?php echo $income['instructions']; ?><p><strong class="green"><?php echo $income['points']; ?> 积分</strong></p>
                          </div>
                          <div class="rightBlock">
                              <span class="time"><?php echo date("Y-m-d H:i:s",$income['create_time']); ?></span>
                          </div>
                          <div class="clear"></div>
                      </div>
