<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:50:"C:\wamp64\www/application/home\view\all\index.html";i:1492156217;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<title>Home</title>
					...
					<div id="small-dialog" class="mfp-hide">
						...
						<div class="signup">
							<form form id="login_run" name="login_run" method="post" action="<?php echo url('login_run'); ?>">
								<input type="text" class="email" name="username" placeholder="输入邮箱/手机号码" required="required" pattern="([\w-\.]+@([\w-]+\.)+[\w-]{2,4})?"/>
				...
				<div class="top-grids">
					...
					<div class="col-md-4 resent-grid recommended-grid slider-top-grids">
						<div class="resent-grid-img recommended-grid-img">
							<a href="/home/index/single.html"><img src="__img__/12.jpg" alt="" /></a>
						</div>
						<div class="resent-grid-info recommended-grid-info">
							<h3><a href="/home/index/single.html" class="title title-info">シャープさんとタニタくん＠</a></h3>
							<ul>
					...
					<div class="col-md-4 resent-grid recommended-grid slider-top-grids">
						<div class="resent-grid-img recommended-grid-img">
							<a href="/home/index/single.html"><img src="__img__/13.jpg" alt="" /></a>
						</div>
						<div class="resent-grid-info recommended-grid-info">
							<h3><a href="/home/index/single.html" class="title title-info">猫彼氏</a></h3>
							<ul>
				...
				<div class="recommended">
					<div class="recommended-grids">
						...
						<div class="col-md-3 resent-grid recommended-grid">
							<div class="resent-grid-img recommended-grid-img">
								<a href="/home/index/single.html"><img src="__img__/19.jpeg" alt="" /></a>
								
							</div>
							<div class="resent-grid-info recommended-grid-info video-info-grid">
								<h5><a href="/home/index/single.html" class="title">头条都是他</a></h5>
								<ul>
