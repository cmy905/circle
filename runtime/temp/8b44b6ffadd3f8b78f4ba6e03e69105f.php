<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:52:"C:\wamp64\www/application/home\view\index\index.html";i:1492968545;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<title>Home</title>
					...
					<div id="small-dialog" class="mfp-hide">
						...
						<div class="signup">
							<form  id="login_run" name="login_run" method="post" action=<?php echo url('login_run'); ?>>
								<input type="text" id="email" class="email" name="email" placeholder="输入邮箱" required="required" pattern="([\w-\.]+@([\w-]+\.)+[\w-]{2,4})?"/>
								<input type="password" id="password" name="password" placeholder="输入密码" required="required" pattern=".{6,}" title="密码至少六位" autocomplete="off" />
								<input type="submit"  id="loginsub" value="登录"/>
							</form>
...
<script src="__js__/jparticle.jquery.js"></script>
    ...
    $(function(){
        ...
        function checkForm(){
            ...
            $("loginsub").removeClass('btn-primary').addClass('btn-danger').text("登录中...");
        }
        ...
        function complete(data){
            if(data.code==1){
                ...
                $("loginsub").removeClass('btn-danger').addClass('btn-primary').text("登　录");
                return false;
            }
			...
			<div class="main-grids">
							...
							<ul class="rslides" id="slider3">
								<li>
									<div class="animated-grids">
										...
										<div class="col-md-3 resent-grid recommended-grid slider-first">
											<div class="resent-grid-img recommended-grid-img">
												<a href="<?php echo url('single',array('book'=>24)); ?>"><img src="__img__/16.jpg" alt="" /></a>
												
											</div>
											<div class="resent-grid-info recommended-grid-info">
												<h5><a href="<?php echo url('single',array('book'=>24)); ?>" class="title">当神不让</a></h5>
												<div class="slid-bottom-grids">
													<div class="slid-bottom-grid">
										...
										<div class="col-md-3 resent-grid recommended-grid slider-first">
											<div class="resent-grid-img recommended-grid-img">
												<a href="<?php echo url('single',array('book'=>25)); ?>"><img src="__img__/17.jpg" alt="" /></a>
												
											</div>
											<div class="resent-grid-info recommended-grid-info">
												<h5><a href="<?php echo url('single',array('book'=>25)); ?>" class="title">非人哉</a></h5>
												<div class="slid-bottom-grids">
													<div class="slid-bottom-grid">
										...
										<div class="col-md-3 resent-grid recommended-grid slider-first">
											<div class="resent-grid-img recommended-grid-img">
												<a href="<?php echo url('single',array('book'=>23)); ?>"><img src="__img__/18.jpg" alt="" /></a>
												
											</div>
											<div class="resent-grid-info recommended-grid-info">
												<h5><a href="<?php echo url('single',array('book'=>23)); ?>" class="title">我家大师兄脑子有病</a></h5>
												<div class="slid-bottom-grids">
													<div class="slid-bottom-grid">
				...
				<div class="recommended">
					<div class="recommended-grids">
						...
						<div class="col-md-3 resent-grid recommended-grid">
							<div class="resent-grid-img recommended-grid-img">
								<a href="<?php echo url('single',array('book'=>22)); ?>"><img src="__img__/20.jpeg" alt="" /></a>
								
							</div>
							<div class="resent-grid-info recommended-grid-info video-info-grid">
								<h5><a href="<?php echo url('single',array('book'=>22)); ?>" class="title">南烟斋笔录</a></h5>
								<ul>
					...
					<div class="recommended-grids">
						<div class="col-md-3 resent-grid recommended-grid">
							<div class="resent-grid-img recommended-grid-img">
								<a href="<?php echo url('single',array('book'=>24)); ?>"><img src="__img__/23.jpg" alt="" /></a>
