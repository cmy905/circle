<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:55:"C:\wamp64\www/application/home\view\classify\index.html";i:1492963944;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<title>History</title>
					...
					<div class="recommended">
						<div class="recommended-grids english-grid">
							<div class="recommended-info">
								<div class="heading">
									<h3><?php echo $taginfo['tag']; ?>漫画</h3>
								</div>
							
								<div class="clearfix"> </div>
							</div>
							<?php if(is_array($list) || $list instanceof \think\Collection): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$comics): $mod = ($i % 2 );++$i;?>
							<div class="col-md-3 resent-grid recommended-grid movie-video-grid">
							    
								<div class="resent-grid-img recommended-grid-img">
									<a href="<?php echo url('index/single',array('book'=>$comics['id'])); ?>"><img src="<?php echo $comics['image_path']; ?>"  alt="" /></a>
								</div>
								<div class="resent-grid-info recommended-grid-info recommended-grid-movie-info">									
									<ul>
										<li><p class="author author-info"><a href="#" class="author">更新至<?php echo $comics['update_until']; ?>章</a></p></li>
								        <li class="right-list"><p class="views views-info"><?php echo $comics['browse_count']; ?> views</p></li>
									</ul>
								</div>
							...
							<script>
								...
								function comic_detail(id){

									//var username = $("#username").val();

									$.ajax({
								        url:"<?php echo url('comic_detail'); ?>",
								        type:'POST', //GET
								        ...
								        success:function(data,textStatus,jqXHR){
								            if(data.code==1){
								                ...
								                function(index){
								                    ...
								                    window.location.href = "<?php echo url('comics_detail'); ?>"+"?book="+id;
								                });
								            }else{
