<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:60:"/home/wwwroot/default/application/home/view/index/shows.html";i:1491827909;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<title>single</title>
			...
			<div class="top-navigation">
				...
				<div class="drop-navigation drop-navigation">
				  <ul class="nav nav-sidebar">
					...
					<li><a href="/home/concern/concern.html" class="sub-icon"><span class="glyphicon glyphicon-home glyphicon-hourglass" aria-hidden="true"></span>收藏</a></li>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			<div class="show-top-grids">
				<div class="col-sm-8 single-left">
					<img id="content_img" src="<?php echo $img['image_path']; ?>" style="width: 100%;">
					<br /><br />
					<input type="button" id="last" class="btn btn-primary" style="margin-left: 40%;" name="read" value="上一页">
						&nbsp;&nbsp;&nbsp;
						<input type="button" id="next" class="btn btn-info" name="read" value="下一页">
				</div>
				<script type="text/javascript" src="__js__/jQuery.imgAutoSize.js"></script>
				<script type="text/javascript">
					$('#content_img').imgAutoSize();
					$('#last').click(function(event) {
						/* Act on the event */
						window.location.href="<?php echo url('shows',$page['last']); ?>";
					});
					$('#next').click(function(event) {
						/* Act on the event */
						window.location.href="<?php echo url('shows',$page['next']); ?>";
					});
				</script>
