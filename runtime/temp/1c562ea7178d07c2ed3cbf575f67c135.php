<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:52:"C:\wamp64\www/application/home\view\index\shows.html";i:1493036567;}*/ ?>
<html>
<head>
<meta charset="utf-8">
                ...
                <dd style="height:120px;">
                    <div class="osx">
                        ...
                        <?php if(is_array($chapterInfo) || $chapterInfo instanceof \think\Collection): $i = 0; $__LIST__ = $chapterInfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$chapter): $mod = ($i % 2 );++$i;if($chapter['no']<$img['zid']): ?>
                            <a  onclick="read(<?php echo $chapter['no']; ?>)"><?php echo $chapter['no']; ?><?php echo $chapter['chaptername']; ?></a>
                        <?php elseif($chapter['no'] == $img['zid']): ?>
                            <a class="curr"   onclick="read(<?php echo $chapter['no']; ?>)"><?php echo $chapter['no']; ?><?php echo $chapter['chaptername']; ?></a>
                         <?php else: ?>
                            <a  onclick="read(<?php echo $chapter['no']; ?>)"><?php echo $chapter['no']; ?><?php echo $chapter['chaptername']; ?></a>
...
<div id="readtop">
    ...
    <span class="author">
        <a href="<?php echo url('/home/upload/usercomics',array('id'=>$auther['id'])); ?>" target="_blank"><?php echo $auther['nickname']; ?></a>
    </span>
    ...
    <!--翻页 end-->
                ...
                <script type="text/javascript">
                    ...
                    $('#last').click(function(event) {
                        ...
                        window.location.href="<?php echo url('shows',$page['last']); ?>"+"?book="+<?php echo $bookinfo['id']; ?>;
                    });
                    $('#next').click(function(event) {
                        /* Act on the event */
                       // $yid=<?php echo $ye; ?>+1;
                        window.location.href="<?php echo url('shows',$page['next']); ?>"+"?book="+<?php echo $bookinfo['id']; ?>;
                    });
                    $('#to_prev_chapter').click(function(event) {
                        /* Act on the event */
                        
                        window.location.href="<?php echo url('shows',$chapters['last']); ?>"+"?book="+<?php echo $bookinfo['id']; ?>;
                    });
                    $('#to_next_chapter').click(function(event) {
                        /* Act on the event */
                       // $yid=<?php echo $ye; ?>+1;
                        window.location.href="<?php echo url('shows',$chapters['next']); ?>"+"?book="+<?php echo $bookinfo['id']; ?>;
                    });
                    $('#comic_name').click(function(event) {
                                        /* Act on the event */
                        window.location.href="<?php echo url('single',array('book'=>$bookinfo['id'])); ?>";
                    });  
                </script> 
