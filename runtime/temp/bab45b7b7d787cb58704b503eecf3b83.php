<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:39:"./template/home/default\help\index.html";i:1487053225;s:42:"./template/home/default\Public\header.html";i:1487293929;s:42:"./template/home/default\Public\footer.html";i:1487141259;}*/ ?>
<!DOCTYPE html>
...
<div class="container clearfix">
    <div class="center">
        <div class="box content clearfix">
            <div class="heading">
                <h1><?php echo $help_list['name']; ?></h1>
            </div>
            <div class="inner-content">
            	<?php echo $help_list['content']; ?>
			</div>
        </div>
    </div>
    <div class="side-left">
        <div id="help-center" class="box help-center">
            ...
            <ul>
                 <?php if(is_array($help) || $help instanceof \think\Collection): $i = 0; $__LIST__ = $help;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$hp): $mod = ($i % 2 );++$i;?>
	                <li>
	                    <a href="<?php echo $hp['url']; ?>" <?php if($id == $hp['id']): ?> class="active"<?php endif; ?>>
							<?php echo $hp['name']; ?>
							<span></span>
	                    </a>
	                </li>
