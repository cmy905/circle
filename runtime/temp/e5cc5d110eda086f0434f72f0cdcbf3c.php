<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:66:"/home/wwwroot/default/application/home/view/upload/upload_pic.html";i:1491827911;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<title>History</title>
			        ...
			        <div class="upload-right-bottom-grids">
						<div class="col-md-4 upload-right-bottom-left">
							...
							<div class="upload-right-top-list">
								<ul>
									<li><a href="#"><?php echo $bookinfo['title']; ?></a></li>
								</ul>
							</div>
						</div>
						<div class="col-md-4 upload-right-bottom-left">
							...
							<div class="upload-right-top-list">
								<ul>
									<li><a href="#">第<?php echo $chapter; ?>章</a></li>
								</ul>
							</div>
						</div>
						<div class="col-md-4 upload-right-bottom-left">
							...
							<div class="upload-right-top-list">
								<ul>
									<li><a href="#">第<?php echo $page; ?>页</a></li>
								</ul>
							</div>
						</div>
						<div class="clearfix"> </div>
					</div>
                    <div class="upload-right" style="width: 75%">
