<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:43:"./template/home/default\account\amount.html";i:1487063857;s:42:"./template/home/default\Public\header.html";i:1487293929;s:40:"./template/home/default\Public\left.html";i:1487056634;s:42:"./template/home/default\Public\footer.html";i:1487141259;}*/ ?>
<!DOCTYPE html>
    ...
    <div class="member_main">
        <div class="perInfo">
            <div class="titleInfoBorder">
                <span>在线充值</span>
                <a class="want" href="<?php echo url('/account/record'); ?>">充值记录</a>
            </div>
       ...
       <div class="tishi">
            <p class="tishi_text">
                <span class="tishi_span">充值提示</span>
            </p>
            <p class="tishi_text">
            	
              	 网站已经开通在线充值积分功能，目前支持<b>微信扫码支付</b>、<b>网银支付</b>、<b>信用卡支付</b>、<b>储蓄卡支付</b>！
            </p>

            <p class="tishi_text">
            	温馨提示：恶意提交充值次数3次以上的一律封号处理，谢谢配合！
            </p>
        </div>
        <form action="<?php echo url('/pay'); ?>" method="post" id="form_pay">
            <div class="setting-right-wrap wrap-boxes settings">
                <p class="red">1元 = <b>10</b> 积分<!--，1元 = <b>1</b> 火币--></p>
                <div id="setting-profile" class="setting-wrap setting-profile">
                     <div class="wlfg-wrap">
                        <label class="label">充值类型</label>
                        <label><input type="radio" name="type" value="0" autocomplete="off" checked=""> 积分</label>
                       
                    </div>
                    <div class="wlfg-wrap">

                        <label class="label">充值金额</label>
                        <input type="text" name="money" id="money" value="0" style="width:150px" onfocus="checkMoney()" onkeyup="checkMoney()"  class="form_input" autocomplete="off"> 元
                    
                        <span style="color:red;margin:0 0 0 5px" id="points">0</span> <span class="unit_name">积分</span>
                        

                    </div>

                    <div class="wlfg-wrap" style="margin-top:10px;">

                        <label class="label">备注	</label>
                        <input type="text" name="remarks" id="remarks" value="" style="width:100px"  class="form_input" autocomplete="off">     

                    </div>
                    
                    <div class="wlfg-wrap">
                        <label class="label"></label>
                        <button class="btn" type="button"  id="btn_submit" onclick="subPayForm()">提 交</button>
                        <input type="hidden" name="order_name" value="积分充值">
                        <input type="hidden" name="payment" value="93素材网支付">
...
function checkMoney(){
	...
	var money=$("#money");
	var points=$("#points");
    if(!partten.test(money.val())){	
    	money.val("");
    	return false;
    }
    points.html(10*parseInt(money.val()));
}
function subPayForm(){
	if($("#money").val() <= 1){
		alert("最低充值金额2元");
