<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:39:"./template/home/default\user\login.html";i:1487141322;s:42:"./template/home/default\Public\header.html";i:1487321446;s:42:"./template/home/default\Public\footer.html";i:1487141259;}*/ ?>
<!DOCTYPE html>
...
<div class="wrap">
    <div class="pop-title clearfix">
        <a class="a_underline" href="<?php echo url('/reg/'); ?>">注册</a>
        <div class="pop_name">
    ...
    <form id="login-form" onsubmit="return false">
        <div class="pop-content accountPage">
            <div class="form_item">
               ...
               <input type="text" placeholder="用户名/邮箱" name="username" value="<?php echo \think\Cookie::get('uname'); ?>"  class="form_input" datatype="*4-12" nullmsg="请输入用户名或者邮箱"/>
            </div>	
            <div class="form_item">
                  <input type="password"  placeholder="密码" name="password" value="<?php echo \think\Cookie::get('pwd'); ?>" class="form_input" datatype="*6-20" nullmsg="请输入密码"/>
            </div>
