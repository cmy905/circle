<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:60:"C:\wamp64\www/application/home\view\upload\uploadcomics.html";i:1491361075;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<title>History</title>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			<div class="show-top-grids">
				...
				<!--<div class="col-sm-8 single-left">-->
					...
					<br /><br />
						<input type="button" id="detail" class="btn btn-primary" style="margin-left: 50px;" name="detail" value="详情">	
							...
							<script>
								$(document).ready(function () {
									...
									$('#read').click(function(event) {
										/* Act on the event */
										window.location.href="<?php echo url('shows',array('book'=>$book['id'])); ?>";
									});
