<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:60:"C:\wamp64\www/application/home\view\personal\usercomics.html";i:1493433770;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<title>主页</title>
						...
						<div class="recommended-grids english-grid">
							...
							<div class="col-md-3 resent-grid recommended-grid movie-video-grid">
								<div class="resent-grid-img recommended-grid-img">
									<a target="_blank" href="<?php echo url('/home/index/single',array('book'=>$book['id'])); ?>"><img  src="<?php echo $book['image_path']; ?>" alt="" /></a>
									<div class="clck movie-clock">
										<span class="glyphicon glyphicon-time" aria-hidden="true"></span>
									</div>
								</div>
								<div class="resent-grid-info recommended-grid-info recommended-grid-movie-info">
									<a herf="<?php echo url('/home/index/single',array('book'=>$book['id'])); ?>"  class="play-icon">查看</a>
