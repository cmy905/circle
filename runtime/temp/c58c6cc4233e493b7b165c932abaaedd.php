<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:37:"./template/home/default\user\reg.html";i:1487037943;s:42:"./template/home/default\Public\header.html";i:1487065584;s:42:"./template/home/default\Public\footer.html";i:1487141259;}*/ ?>
<!DOCTYPE html>
...
<div class="wrap">
    <div class="pop-title clearfix">
        <a class="a_underline" href="<?php echo url('/login/'); ?>">登录</a>
        <div class="pop_name">
            <span class="grey">与网友进行讨论及互动；收藏您喜欢的文章和内容；积累积分下载原创模板、精品源码；分享代码、解决求助赢取金币。</span>
        </div>

    </div>
    <form id="reg-form" action=""  onsubmit="return false">
        <div class="pop-content accountPage">
            <div class="form_item">     
                <input type="text" placeholder="用户名" name="username"  class="form_input" datatype="*4-12" nullmsg="允许用中英文、数字、下划线"/>

            </div>
            <div class="form_item">
                <input type="text" placeholder="邮箱用于找回密码"  name="email" class="form_input"  datatype="e" nullmsg="邮箱用于找回密码,请正确填写邮箱" errormsg="邮箱格式不正确，请重新填写"/>

            </div>	
            
            <div class="form_item">
                <input type="password"  placeholder="密码" name="password"  class="form_input" datatype="*6-20" nullmsg="请设置密码" errormsg="密码长度范围在6~20位之间！"/>
                
            </div>			
            <div class="form_item">
                <input type="password" placeholder="确认密码" name="confirm_password" class="form_input"  recheck="password" datatype="*6-20" nullmsg="请再输入一次密码！" errormsg="您两次输入的账号密码不一致！"/>
             
            </div>
             
            <div class="form_item" style="margin:30px  0 0">
                <input type="submit" tabindex="7" value="注&nbsp;&nbsp;册" class="btn_reg btn" id="btn-reg"/>
            </div>
