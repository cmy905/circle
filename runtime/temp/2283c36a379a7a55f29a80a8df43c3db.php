<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:47:"./template/home/default\setting\change_pwd.html";i:1487061118;s:42:"./template/home/default\Public\header.html";i:1487065584;s:40:"./template/home/default\Public\left.html";i:1487056634;s:42:"./template/home/default\Public\footer.html";i:1487060599;}*/ ?>
<!DOCTYPE html>
...
<body> 
 ...
 <div id="nav" class="nav">
    <div class="nav_main clearfix">
    	<!-- current -->
	     <?php if(is_array($nav) || $nav instanceof \think\Collection): $i = 0; $__LIST__ = $nav;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$menu): $mod = ($i % 2 );++$i;?>
           <a href="<?php echo $menu['nav_url']; ?>"<?php if($menu['id'] == 1): ?>class="menu current"<?php else: ?>class="menu"<?php endif; ?>><?php echo $menu['nav_name']; ?></a>
        <?php endforeach; endif; else: echo "" ;endif; ?>
            ...
            <div class="pwd-reset-wrap setting-resetpwd">
               <form id="find-form">
                    <div class="wlfg-wrap">
                        ...
                        <div class="rlf-group">
                            <input class="rlf-input rlf-input-pwd error" type="password" placeholder="请输入当前密码" name="pwdold" maxlength="20" datatype="*6-20" nullmsg="请输入原密码" errormsg="密码长度范围在6~20位之间！">
                    ...
                    <div class="wlfg-wrap">
                        ...
                        <div class="rlf-group">      
                            <input  class="rlf-input rlf-input-pwd error" type="password" placeholder="请输入密码" name="password" maxlength="20" datatype="*6-20" nullmsg="请输入密码" errormsg="密码长度范围在6~20位之间！">
                    ...
                    <div class="wlfg-wrap">
                        ...
                        <div class="rlf-group">
                            <input id="pwd2" class="rlf-input rlf-input-pwd error" type="password" placeholder="请输入原密码" name="confirm_password" maxlength="20" recheck="password" datatype="*6-20" nullmsg="请输入原密码" errormsg="两次密码输入不一致">
                    ...
                    <div class="wlfg-wrap">
                        ...
                        <div class="rlf-group">
                            <button id="pwd_save" class="btn-green btn" type="button">保存</button>
                        </div>
                    </div>
                </form>
            </div>
...
$(document).ready(function(){	
	...
	var settings=$("#find-form").Validform({
		tiptype:3,
		label:".label",
		showAllError:true,
		ajaxPost:true,
	...
	settings.config({
	    url:"/setting/modify_pwd"
	});
})
</script>
<div class="footer" id="footer" data-url="dsadsa">
    ...
    <div class="pop_content">
        ...
        <div class="captchaBox">
            <div class="two_weeks">
                ...
                <a href="<?php echo url('user/reg'); ?>" target="_blank" class="loginbox_reg">免费注册</a>
            </div>
        </div>
        <input type="submit" tabindex="7" value="登  录" class="btn_reg btn" id="btn-login">
        <a class="a_underline" href="<?php echo url('user/forget'); ?>">忘记密码？</a>
