<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:43:"./template/admin/default\user\useredit.html";i:1490935413;s:43:"./template/admin/default\public\header.html";i:1490935414;s:43:"./template/admin/default\public\footer.html";i:1490935414;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="main-wrap">
    ...
    <form class="layui-form" action="<?php echo url('userEdit'); ?>">
        <input type="hidden" name="id" value="<?php echo $user['id']; ?>">
        <div class="layui-form-item">
            <label class="layui-form-label">管理员名称</label>
            <div class="layui-input-inline">
                <input class="layui-input" type="text" name="username" placeholder="管理员名称"  lay-verify="title" value="<?php echo $user['username']; ?>">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input class="layui-input" type="text" name="real_name" placeholder="真实姓名"  lay-verify="required" value="<?php echo $user['real_name']; ?>">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            <div class="layui-input-block">
                <button class="layui-btn" lay-submit="" lay-filter="add-role" data-href="<?php echo url('userEdit'); ?>">立即提交</button>
