<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:58:"C:\wamp64\www/application/home\view\concern\user_info.html";i:1492156220;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<title>漫画管理</title>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			<div class="show-top-grids">
					...
					<div class="recommended">
						<div class="recommended-grids english-grid">
							<div class="recommended-info">
								<div class="heading">
									<h3><?php echo $userinfo['nickname']; ?>的漫画</h3>
								</div>
							
								<div class="clearfix"> </div>
							</div>
							<?php if(is_array($list) || $list instanceof \think\Collection): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$usercomics): $mod = ($i % 2 );++$i;?>
							<div class="col-md-3 resent-grid recommended-grid movie-video-grid">
							    
								<div class="resent-grid-img recommended-grid-img">
									<a><img src="<?php echo $usercomics['image_path']; ?>" alt="" /></a>
								</div>
								<div class="resent-grid-info recommended-grid-info recommended-grid-movie-info">									
									<ul>
										<li><p class="author author-info"><a href="#" class="author">更新至<?php echo $usercomics['update_until']; ?>章</a></p></li>
								        <li class="right-list"><p class="views views-info"><?php echo $usercomics['browse_count']; ?> views</p></li>
									</ul>
								</div>
				...
				<div class="col-md-2 show-grid-right">
					<h3><?php echo $userinfo['nickname']; ?>的信息</h3>					
