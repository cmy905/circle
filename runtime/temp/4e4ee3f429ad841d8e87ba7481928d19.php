<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:69:"/home/wwwroot/default/application/home/view/upload/upload_comics.html";i:1492079983;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<title>新增漫画</title>
                ...
                <div class="upload-grids">
                    ...
                    <div class="upload-right-bottom-grids">
                     <div class="recommended-info">
                        ...
                        <br /><br />
                        <h3>漫画说明</h3>
                            <input type="text" class="form-control" placeholder="" id="detail" style="height: 170px;">
                       <br /><br />

                        <h3>标签</h3>
                            <input type="text" class="form-control" placeholder="" id="tag">
                       <br /><br />
                      
                        <div class="file">
                               <input type="submit" name="sub" class="btn btn-primary" href="/home/upload/usercomics.html" value="提交">
                        </div>
                         </form> 
                        <div class="clearfix"> </div>
                    </div>
