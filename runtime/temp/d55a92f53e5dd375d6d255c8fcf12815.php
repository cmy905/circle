<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:42:"./template/home/default\message\index.html";i:1487063156;s:42:"./template/home/default\Public\header.html";i:1487293929;s:40:"./template/home/default\Public\left.html";i:1487056634;s:42:"./template/home/default\Public\footer.html";i:1487141259;}*/ ?>
<!DOCTYPE html>
...
<div class="container clearfix">
    ...
    <div class="member_main">
        ...
        <?php if(empty($message_list) || ($message_list instanceof \think\Collection && $message_list->isEmpty())): ?>
         <div class="infoNoData">
             	  无任何消息
      	</div>
        <?php else: if(is_array($message_list) || $message_list instanceof \think\Collection): $i = 0; $__LIST__ = $message_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$message): $mod = ($i % 2 );++$i;?>
                <div class="message" id="message_<?php echo $message['id']; ?>">
                      <div class="centerBlock">
                          <div class="infoNews"><?php echo $message['content']; ?></div>
                      </div>

                      <div class="rightBlock">
                        <a href="javascript:void(0)" rel="<?php echo $message['id']; ?>" style="color:#ccc">删除</a>
                        <span class="time"><?php echo $message['send_time']; ?></span>
                      </div>
                 </div>
