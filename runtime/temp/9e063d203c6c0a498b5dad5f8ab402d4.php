<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:43:"./template/home/default\setting\points.html";i:1487062942;s:42:"./template/home/default\Public\header.html";i:1487293929;s:40:"./template/home/default\Public\left.html";i:1487056634;s:42:"./template/home/default\Public\footer.html";i:1487141259;}*/ ?>
<!DOCTYPE html>
    ...
    <div class="member_main">
        <div class="perInfo">
            <div class="titleInfoBorder">
                <span>财务记录</span>
                <a class="want" href="<?php echo url('/account/amount'); ?>">去充值</a>
            </div>
        </div>
        ...
        <?php else: ?>
         <table class="table_member">
                <thead><tr>
                    <th align="center">财务属性</th>
                    <th align="center"></th>
                    <th align="center">说明信息</th>
                    <th align="center">操作时间</th>
                    <th align="center">状态</th>
                </tr>
                </thead>
                <tbody>
                <?php if(is_array($income_list) || $income_list instanceof \think\Collection): $i = 0; $__LIST__ = $income_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$income): $mod = ($i % 2 );++$i;?>
                    <tr>
                        <td><b class="green"><?php if($income['type'] == 1): ?>收入<?php else: ?>支出<?php endif; ?></b></td>
                         <td width="100px"><?php echo $income['points']; ?> 积分</td>
                        <td><?php echo $income['instructions']; ?></td>
                        <td><?php echo date("Y-m-d H:i:s",$income['create_time']); ?></td>
                        <td><span style="color:#FF6600"><?php if($income['status'] == 1): ?>已完成<?php else: ?>未完成<?php endif; ?></span></td>
                    </tr>
                <?php endforeach; endif; else: echo "" ;endif; ?>
